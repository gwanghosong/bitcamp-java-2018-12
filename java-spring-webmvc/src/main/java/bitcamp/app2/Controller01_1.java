...
public class Controller01_1 {
  ...
  // 테스트:
  //      http://localhost:8080/java-spring-webmvc/app1/c01_1/h1
  @GetMapping("h1")
  public String handler1() {
    ...
    //  : InternalResouceViewResolver의 경우 
  ...
  // 테스트:
  //      http://localhost:8080/java-spring-webmvc/app1/c01_1/h2
  @GetMapping("h2")
  public void handler2() {
    // InternalResouceViewResolver를 사용하는 경우
