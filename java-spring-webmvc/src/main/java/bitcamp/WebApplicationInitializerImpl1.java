...
//    : 호출할 때 @HandlesTypes(WebApplicationInitializer.class) 참조해서
//      WebApplicationInitializer.class를 구현한 클래스 목록을 넘겨준다.
