...
<body>
  ...
  <form action='update' method='post' enctype='multipart/form-data'>
    <table border='1'>
      <tr>
        <th>번호</th>
        <td><input type='number' name='no' value='<%=member.getNo()%>' readonly></td>
      </tr>
      <tr>
        <th>이름</th>
      ...
      <tr>
        <th>사진</th>
        <td>
          <%if (member.getPhoto() == null) {%> <img src='../images/default.jpeg' style='height: 80px'>
          <%} else {%> <img src='../upload/member/<%=member.getPhoto()%>' style='height: 80px'>
