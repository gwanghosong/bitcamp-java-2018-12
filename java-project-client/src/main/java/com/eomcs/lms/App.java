...
public class App {
  ...
  public void service() {
    ...
    LessonDaoImpl lessonDao = new LessonDaoImpl("localhost", 8888, "/lesson");
    ...
    MemberDaoImpl memberDao = new MemberDaoImpl("localhost", 8888, "/member");
    ...
    BoardDaoImpl boardDao = new BoardDaoImpl("localhost", 8888, "/board");
