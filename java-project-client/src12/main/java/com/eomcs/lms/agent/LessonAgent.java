...
public class LessonAgent {
  ...
  public static List<Lesson> list(ObjectInputStream in, ObjectOutputStream out) throws Exception {
  ...
  public static void update(Lesson lesson, ObjectInputStream in, ObjectOutputStream out) throws Exception {
