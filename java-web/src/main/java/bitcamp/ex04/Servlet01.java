...
public class Servlet01 extends GenericServlet { 
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // : 웹 페이지의 폼(method='GET' 일때)에서 전송 버튼을 클릭하면 GET 요청을 보낸다. 
    //
    // 테스트
...
//      : 이를 방지하고자 데이터를 7bit로 변환한다.
//      : 어떻게? 원래 코드 값을 아스키(ASCII) 문자 코드로 변환한다.
//      : ASCII 코드는 7비트이기 때문에 데이터를 주고받을 때 깨지지 않을 것이다.
...
//          42 ==> 42
//          43 ==> 43
//          코드 값이 ASCII가 아니라면 각 4비트 값을 아스키 문자로 간주하고 코드로 변환한다.
//          E ==> 'E' ==> 45
//          A ==> 'A' ==> 41
//          이렇게 변환한 후, URL인코딩 값임을 표시하기 위해 앞에 '%' 코드를 붙인다.
...
// HTTP 응답 프로토콜
// : 형식
//    status-line(HTTP 프로토콜 상태코드 간단한 문구) CRLF
...
Content-Length: 27(바이트숫자)
Date: Thu, 28 Mar 2019 05:45:55 GMT
CRLF
이름=홍길동(LF)
나이=20(LF)
 */
