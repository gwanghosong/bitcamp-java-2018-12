...
public class Servlet03 extends HttpServlet { 
  ...
  protected void service(
    ...
    //    바로 다른 페이지로 이동한다.
    //  : 리프레시와 달리 서버는 콘텐트(message-body)를 보내지 않는다.
    //  : 사용 예)
    ...
    /*
           ...
           Content-Length: 0
           Date: Tue, 02 Apr 2019 03:39:22 GMT
     */
    ...
    // forward/include와 달리 '/'는 컨텍스트 루트(웹 애플리케이션 루트, localhost:8080/java-web/)가 아닌
    // 웹서버 루트(localhost:8080/)를 의미한다.
