...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    // private으로 보호되고 있는 메서도는 값을 임의로 왜곡할 수 없다.
...
/*
 ...
 인스턴스멤버 : 인스턴스 필드, 인스턴스 블록, 인스턴스 메서드, 생성자
 ...
 코딩할 때 일관성 있는 프로그래밍을 하게 도와주는 문법.
 오버라이딩(overriding): 상속 받은 메서드를 자신의 역할에 맞게 재정의하는 것.
 다형적 변수 (polymorphic variable)
  하나의 변수가 여러 타입을 가리킬 수 있고, 다양한 타입으로 다뤄질수 있게 도와주는 문법.
  ...
  - protected : 같은 패키지에 소속되거나 자손 클래스의 멤버만 접근가능
  - public : 모두 접근 가능
  
  !getter/setter
  캡슐화와 더불어 사용되는 기술이다.
  필드에 대해 외부의 직접적인 접근을 막는 대신 메서드를 통해 값을 변경, 조회하도록 유도한다.
  메서드에서 값의 유효 범위를 검사하여 변경을 허락할 수있다.
