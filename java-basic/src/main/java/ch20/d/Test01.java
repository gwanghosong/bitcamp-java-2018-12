...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // 맵에 값 저장하기
    // key 객체에 대해 hashCode()를 호출하여 정수값을 얻는다.
    ...
    // 3) 해당 위치에 있는 key 객체와 equals()를 호출하여 리턴값을 확인한다.
    // 4) equals()의 리턴 값이 true라면 같은 key로 간주하여 해당 위치의 값을 꺼낸다.
    
    String key1 = "bbb";
    String key2 = new String("bbb");
    System.out.println(key1 == key2); // key1과 key2는 인스턴스가 다르다.
    ...
    // equals의 리턴 값이 true이므로 두 인스턴스는 같은 key로 간주한다.
