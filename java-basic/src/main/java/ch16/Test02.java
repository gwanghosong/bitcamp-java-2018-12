// 제네릭(generic) 적용전 - Object를 이용한 다형적 변수 사용할 때 형변환이 불편하다.
package ch16;
...
public class Test02 {
  public static void main(String[] args) {
    ...
    // echo() 리턴 값을 원하는 타입으로 받기 위해 형변환 해야 하는 일이 번거롭다.
    ...
    // 형변환 할 필요가 없다.
    // 그러나 각 타입에 맞는 echo()를 여러개 정의해야 하기 때문에
    // 그것도 똑같은 기능을 수행하는 메서드를 여러개 만들어야 하기 때문에
    // 유지보수에 좋지 않다.
