...
public class Test07_2 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (column.length() > 0) {
      ...
      // 다음과 같이 자바 코드로 컬러명을 지정한다.
      switch (column) {
        // 이렇게 일렬로 처리하면 title이 선택되면 쭉넘어가서 params.put("column", column); 이 실행되고 break;로 나간다.
        // case "title": case "contents": case "created_date": 
        // case "view_count":params.put("column", column); break;
        case "title":
        case "contents":
        case "created_date":
        case "view_count":
