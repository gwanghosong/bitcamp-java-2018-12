...
public class Test08 {
  ...
  public static void main(String[] args) {
    ...
    // key는 값을 저장할 위치를 계산할 때 사용한다.(key / 배열 개수 = 저장할 위치)
    // map.put(key, value)
    
    // put(Object key, Object value)
    // key 값으로 int를 넘겨준다?
    // auto-boxing!
    // 내부적으로 오토박싱을 수행하여 Integer 객체를 만든다.
    // 그리고 그 객체를 넘겨주는 것이다.
    ...
    System.out.println(k2.hashCode()); // hashCode는 같다.
    ...
    // 원래의 키와 내용물이 같은지 equals로 한번더 비교한다.
