...
public class Test02 {
  ...
  public static void main(String[] args) {
    ...
    try (Scanner keyboard = new Scanner(System.in);){
      ...
      try ( // 이렇게 객체를 이 괄호에서 준비하면 자동으로 close()를 호출해주기 때문에
              // 개발자는 코딩하기 편하다.
      ...
      // JVM이 try () 에 선언한 레퍼런스에 대해 try블록을 벗어나기 전에 close()를 자동 호출하기 때문에
      // 다음과 같이 직접 close()를 호출하는 코드를 작성할 필요가 없다.
      //keyboard.close();
