...
public class Test09 {
  public static void main(String[] args) {
    // 자바는 원시타입 primitive type의 값을 좀 더 정교하게 제어할 수 있도록
    // 자바 원시타입 각각에 대응하는 클래스를 제공한다.
    ...
    // wrapper 클래스의 생성자가 deprecated(비난받는) 상태이다. 
    // 가능한 생성자를 사용하여 인스턴스를 생성하지 말라!
    // deprecated(비난받는)? 사용하지 않는 것이 좋다고 결정되었고, 
    // 가까운 장래에 제거될것이라는 의미.
    //
    // Integer i1 = new Integer(100); 가능한 이렇게 사용하지 말자!
   ...
   // char c1 = new Character('가')
    ...
    String s = i1.toString(); // int String 인스턴스로 리턴하는 메서드
    ...
    // primitive 데이터를 다루는 메서드를 여러개 만들 필요가 없다.
