...
public class Test19 {
  public static void main(String[] args) {
    ...
    //
    //  예를 들어 개발자가 프로그래밍 가능한 언어를 int값으로 표현해 보자!
    ...
    // 맨 앞자리 부호비트를 제외하고 31bit로 31개의 언어를 int값 한 개로 구분할 수 있다.
   
    // Java와 C, C++, JacaScript 할 줄 아는 개발자의 정보를 설정하라!
    ...
    // 0000 0000 1000 0111 (여러 프로그래밍 언어에 대해 설정된 값)
    // TypeScript 언어를 할 줄 아는지 검사하기
    //      0000  0000  1000  0111
    //  & 0000 0001 0000 0000 (TypeScript 값을 조사하려는 값과 AND 한다.)
    // ----------------------------- (조사하려는 값에 0을 AND하면 무조건 0으로 만든다.)
    //      0000  0000  0000  0000   (조사하려는 값에 1을 AND하면 원래 값 그대로 리턴한다.)
