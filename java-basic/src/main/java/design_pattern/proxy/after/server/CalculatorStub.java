...
public class CalculatorStub implements Calculator {
  ...
  // 인터페이스에서 예외를 던지지 않으면
  // 구현체에서도 throws로 예외를 던질 수 없다.
  // 따라서 try ~ catch 로 처리하고
  // runtimeException으로 스텔스모드로 던진다.
  @Override
