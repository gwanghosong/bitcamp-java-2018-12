...
public class Test14 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 한글이 깨진다. 이유?
    // String 생성자는 파라미터로 받은 바이트 배열에 ISO-8859-1 문자 코드가 들어있다고 간주한다.
    // 즉 0xb0 0xa1 값이 한글 '가'가 아니라 0xb0와 0xa1 각각을 영어라 간주하고 
    // ISO-8859-1 에 정의된 문자표에 따라 화면에 유니코드(UTF-16) 바꿔 저장한다.
    // 0xb0(ISO-8859-1) ==>0x00b0(UTF-16)
    // 0xb0에 해당하는 문자가 출력되는 것이다.
    // 제대로 한글을 처리하려면? 생성자에 바이트 배열을 넘겨줄 때 배열에 들어 있는 코드값이
    ...
    byte[] byte3 = {(byte)0xea, (byte)0xb0, (byte)0x80, (byte)0xea, 
