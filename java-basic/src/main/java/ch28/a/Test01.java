...
//  bin/main/ch28/a/Test01.class 확인
package ch28.a;

@MyAnnotation // 클래스선언에 붙일수있다.
// @MyAnnotation // 같은 애노테이션을 중복으로 붙일 수는 없다.
public class Test01 {

  @MyAnnotation // 필드 선언에 붙일 수 있다.
  static int a;
  
  @MyAnnotation int b; // 애노테이션을 붙인 후에 바로 코드를 작성해도 된다.
  
  @MyAnnotation // 매서드 선언에 붙일 수 있다.
  void m1(
      // 파라미터 : 로컬변수다. 외부 값을 받아 오는 로 컬 변 수 
    ...
    for (@MyAnnotation int i = 0; i < 100; i++) {
      @MyAnnotation int a; // 로컬 변수선언에 붙일 수 있다.
    }
  }
