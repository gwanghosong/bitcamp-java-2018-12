...
//  이 기능을 사용하여 DAO구현체를 생성하여 사용한다.
// 단점: 자바 코드가 mybatis에 종속되는 문제가 있다.
//       다른 persistence framework로 교체하면 전체 코드를 뜯어 고쳐야 한다.
// 스프링프레임워크에서 이 기술을 활용하기 때문에 배우지만 실제로는 매우 리스크있는 방식이다.
// 
// 작업:
// 1) Command 변경
