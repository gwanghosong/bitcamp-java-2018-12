  ...
  public void contextInitialized(Map<String, Object> context) {
    try {
      ...
      context.put("/photoboard/add", 
          new PhotoBoardAddCommand(sqlSessionFactory));
      context.put("/photoboard/list", 
          new PhotoBoardListCommand(sqlSessionFactory));
      context.put("/photoboard/detail", 
          new PhotoBoardDetailCommand(sqlSessionFactory));
      context.put("/photoboard/update", 
          new PhotoBoardUpdateCommand(sqlSessionFactory));
      context.put("/photoboard/delete", 
          new PhotoBoardDeleteCommand(sqlSessionFactory));
      context.put("/photoboard/search", 
          new PhotoBoardSearchCommand(sqlSessionFactory));
