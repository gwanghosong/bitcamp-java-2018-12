...
//    : tx-context.xml
//      스프링 document <tx:advice/> settings 참고해서 설정 
//    : AppConfig에서 @ImportResource("classpath:XML경로")로 설정
// 2) 기존의 서비스 클래스에 붙인 @Transactional 애노테이션을 모두 제거한다.
...
//      Spring IoC 컨테이너에서 Proxy 생성 기술을 사용하기 때문에 AOP기술을 사용할 일이 없다.
