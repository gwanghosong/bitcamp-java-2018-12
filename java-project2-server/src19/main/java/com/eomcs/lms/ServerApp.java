// 19단계: 애노테이션 적용
// : IoC 컨테이너가 객체를 만들 때 클래스의 애노테이션에서 객체이름을 추출하기
//
// IoC (Inversion of Control)
// : 제어의 역전, 제어의 역행, 제어의 도치, 역제어 등으로 표현한다.
//
//  IoC의 대표전인 예:
//    1) DI(Dependency Injection)
//      : 의존 객체 주입
//        사용할 객체를 직접 만들지 않고 외부에서 주입받아 사용하는 방식
//        외부에서 객체를 주입하기 때문에 주입하는 객체를 쉽게 교체할 수 있다.
//        예를 들어 Command 구현체를 테스트할 때 진짜 DAO를 주입하지 않고
//        테스트용 DAO를 주입할 수 있다.
//        그래서 단위 테스트하기가 쉽다.
//    2) event listener
//      : 보통 메서드를 실행할 때 작성된 순서대로 위에서 아래로 실행한다.
...
// : 객체 이름을 저장하기 위해 만든 name 필드와 getter/setter를 제거한다.
